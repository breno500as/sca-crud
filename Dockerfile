...
#Obrigatório explicitar '-Dserver.port=' para o heroku atribuir uma porta dinâmicamente. 
ENTRYPOINT ["java", "-Dserver.port=$SERVER_PORT -Djava.security.egd=file:/dev/./urandom", "-jar", "app.jar"]
