...
public class SubTipoInsumoController {
	...
	public ResponseEntity<List<SubTipoInsumo>> findAllBySubTipoInsumo(@RequestParam("tipoInsumo") Long tipoInsumo) {
		return ResponseEntity.ok(this.repository.findByTipoInsumo(new TipoInsumo(tipoInsumo)));
	}
